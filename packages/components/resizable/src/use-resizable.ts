import type { ResizableVariantProps } from "@cloudstack-design/theme";
...
export type UseResizableProps = Props & ResizableVariantProps;

export function useResizable(originalProps: UseResizableProps) {
  const [props, variantProps] = mapPropsVariants(originalProps, resizable.variantKeys);
