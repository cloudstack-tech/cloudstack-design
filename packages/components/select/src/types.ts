...
import {SelectVariantProps} from "@cloudstack-design/theme";
...
export interface BaseSelectProps<T = any>
  extends Omit<SelectVariantProps, "isSelected" | "isOptionDisabled" | "isOpen"> {
  /**
   * 选项列表
   */
...
export type SelectProps<T = any> = SingleSelectProps<T> | MultipleSelectProps<T>;
