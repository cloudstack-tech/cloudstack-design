import type {InputGroupVariantProps} from "@cloudstack-design/theme";
...
export type UseInputGroupProps = Props & InputGroupVariantProps;
...
export type UseInputGroupReturn = ReturnType<typeof useInputGroup>;
