...
- [x] 创建组件并完成基础实现
- [ ] fix: 组件没有颜色，可能是主题色设置有问题，需要修复
- [ ] fix: 禁用配置项没有生效，哪怕禁用了好像依旧可以交互
- [ ] fix: loading 态配置项没有生效，没有看到加载中的相关状态
- [ ] fix: with content 案例需要优化，理论上如果里面的那个球在左边，那内容应该在右边，反之亦然
- [ ] fix: 组件受控有问题，外部不能传值进去
- [ ] fix: async switch 有问题，和 loading 一样，没有过渡动画
...
- [x] 创建组件并完成基础实现
- [x] fix: 组件样式太丑了，可以参考下 Card 组件的部分 Design Token，不符合组件库设计系统
- [x] fix: 选中以后还会有个类似 ring 一样的东西，不需要去掉
- [x] feat: 文档补充 手风琴 具体的使用场景和案例
- [x] fix: Storybook 文档里的很多都用不了，需要修复实现一下
- [ ] fix: 手风琴的样式还是不对，有待完善，参考卡片可以
